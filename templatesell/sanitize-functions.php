 ...
 */
function pritam_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function pritam_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function pritam_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('pritam_sanitize_number')) :
    function pritam_sanitize_number($input)
    {
